              ...
              <form id="quickForm" method="post" enctype="multipart/form-data">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="Tieude" name="blog_name" class="form-control" id="exampleInputTieude1" placeholder="Tieude">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputNoidung1">Nội Dung</label>
                    <input type="Noidung" name="blog_noidung" class="form-control" id="exampleInputNoidung1" placeholder="Noidung">
                  </div>
                  <div class="form-group">

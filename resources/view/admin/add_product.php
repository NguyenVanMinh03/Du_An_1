          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm Mới</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" enctype="multipart/form-data">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="Tieude" name="product_name" class="form-control" id="exampleInputTieude1" placeholder="Tieude">
                  </div>
                  <div class="form-group">
                    <label >Giá</label>
                    <input type="Noidung" name="price" class="form-control" id="exampleInputNoidung1" placeholder="giá">
                  </div>
                  <div class="form-group">
                    <label >Giá Khuyến Mãi</label>
                    <input type="Noidung" name="price_km" class="form-control" id="exampleInputNoidung1" placeholder="giá Khuyến Mãi">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Tieude" name="thuonghieu" class="form-control" id="exampleInputTieude1" placeholder="Thương Hiệu">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputTieude1">Mã Sản Phẩm</label>
                    <input type="Tieude" name="masp" class="form-control" id="exampleInputTieude1" placeholder="Mã Sản Phẩm">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group" >
                    ...
                    <textarea class="form-control" rows="3" placeholder="Mô tả Sản Phẩm" name="detail"></textarea>
                  </div>

              ...
              <form id="quickForm" method="post" enctype="multipart/form-data">
                <form id="quickForm">
                  <div class="card-body">
                     ...
                     <input type="hidden" name="id" class="form-control" id="exampleInputTieude1" placeholder="Tieude" value="<?= $blog->id ?>">
                      <label for="exampleInputTieude1">Tiêu Đề</label>
                      <input type="Tieude" name="blog_name" class="form-control" id="exampleInputTieude1" placeholder="Tieude" value="<?= $blog->blog_name ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputNoidung1">Nội Dung</label>
                      <input type="Noidung" name="blog_noidung" class="form-control" id="exampleInputNoidung1" placeholder="Noidung" value="<?= $blog->blog_noidung ?>">
                    </div>
                    <img width="20%" src="../img/<?= $blog->hinhanh ?>" alt="">
                    <div class="form-group">

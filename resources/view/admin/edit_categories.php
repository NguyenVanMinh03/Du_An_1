                ...
                <form id="quickForm" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <input type="hidden" name="id" class="form-control" id="exampleInputTieude1" placeholder="name" value="<?= $category->id ?>">
                      <label for="exampleInputTieude1">Tên Danh Mục</label>
                      <input type="Tieude" name="cate_name" class="form-control" id="exampleInputTieude1" placeholder="name" value="<?= $category->cate_name ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group"><br>
                          <br>
                          <img width="10%" src="../img/<?= $category->hinhanh ?>" alt="">

              ...
              <form id="quickForm">
                <div class="card-body">
                   <div class="form-group">
                    ...
                    <input type="Tieude" name="Tieude" class="form-control" id="exampleInputTieude1" placeholder="Tieude">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputNoidung1">Email</label>
                    <input type="Noidung" name="Noidung" class="form-control" id="exampleInputNoidung1" placeholder="Noidung">
                  </div>
                  <div class="form-group">

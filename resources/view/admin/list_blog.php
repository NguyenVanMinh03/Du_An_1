        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/list_blog" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Blog</p>
                </a>
              </li>
          ...
          <tbody>
              <tr>
                  ...
                  <td>
                      <ul class="list-inline">
                          ...
                          <li class="list-inline-item">
                            <img alt="Avatar"  width="20%"   src="../img/<?=$blog->hinhanh?>">
                          </li>
                      </ul>
                  </td>
                  <td class="project_progress card-body">
                     
                  
                     
                      <p class="card-text"> <?=$blog->blog_noidung?></p>
                  ...
                  <td class="project-actions text-right">
                      ...
                      <a class="btn btn-info btn-sm" href="/edit_blog?id=<?=$blog->id?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                      </a>
                      <a class="btn btn-danger btn-sm" href="/delete_blog?id=<?=$blog->id?>" onclick="return confirm('Bạn có muốn xóa không')">

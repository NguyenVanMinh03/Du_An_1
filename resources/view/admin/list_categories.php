        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/list_categories" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Categories</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="add_categories">Thêm Mới</a >
          </div>
          ...
          <tbody>
              <tr>
                  ...
                  <td>
                      <ul class="list-inline">
                          ...
                          <li class="list-inline-item">
                              <img alt="Avatar"  width="100%"   src="../img/<?=$cate->hinhanh?>">
                          </li>
                      </ul>
                  </td>
                  ...
                  <td class="project-actions text-right">
                      ...
                      <a class="btn btn-info btn-sm" href="/edit_categories?id=<?=$cate->id?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                      </a>
                      <a class="btn btn-danger btn-sm" href="/delete_cate?id=<?=$cate->id?>" onclick="return confirm('Bạn có muốn xóa không')">

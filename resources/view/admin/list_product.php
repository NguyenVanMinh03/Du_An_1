        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/list_product" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Product</p>
                </a>
              </li>
        ...
        <th style="width: 20%">
          ...
          <tbody>
              <tr>
                  ...
                  <td>
                      <ul class="list-inline">
                          ...
                          <li class="list-inline-item">
                            <img alt="Avatar"  width="60%"   src="../img/<?=$pro->hinhanh?>">
                          </li>
                      </ul>
                  </td>
                  ...
                  <td class="card-body">
                      <small class="card-text"> <?=$pro->thuonghieu?></small>
                  </td>
                  <td class="card-body">
                    <small class="card-text"> <?=$pro->tinhtrang?></small>
                </td>
            ...
            <!-- <td class="card-body">
                <small class="card-text">bồ em bé</small>
            </td> -->
                  <td class="project-actions text-right">
                      
                      <a class="btn btn-info btn-sm" href="/edit_product?id=<?=$pro->id?>">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                      </a>
                      <a class="btn btn-danger btn-sm" href="/delete_product?id=<?=$pro->id?>" onclick="return confirm('Bạn có muốn xóa không')">

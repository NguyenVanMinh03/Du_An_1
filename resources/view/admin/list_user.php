        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/list_user" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List User</p>
                </a>
              </li>
              ...
              <tr>
                  ...
                  <td>
                      <ul class="list-inline">
                          ...
                          <li class="list-inline-item">
                            <img alt="Avatar"  width="40%"   src="../img/<?=$user->hinhanh?>">
                          </li>
                      </ul>
                  </td>
                ...
                <td class="project_progress card-body">
                  ...
                  <td class="project-actions text-right">
                      ...
                      <a class="btn btn-danger btn-sm" href="/delete_user?id=<?=$user->id?>" onclick="return confirm('Bạn có muốn xóa không')">
